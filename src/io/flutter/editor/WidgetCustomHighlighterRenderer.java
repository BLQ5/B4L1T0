...
public class WidgetCustomHighlighterRenderer extends WidgetViewModel implements CustomHighlighterRenderer, EditorPositionService.Listener, Disposable {
  ...
  boolean updateSelectedHelper(Caret carat) {
    ...
    final CaretModel caretModel = data.editor.getCaretModel();
    ...
    final VisualPosition startPosition = data.editor.offsetToVisualPosition(off);
  ...
  public void paint(@NotNull Editor editor, @NotNull RangeHighlighter highlighter, @NotNull Graphics g) {
    ...
    if (childLines != null && childLines.size() > 0) {
      ...
      if (endPositionLastChild.line == endPosition.line) {
        ...
        if ((endLine + 1) < data.document.getLineCount()) {
          endLine++;
        }
      }
    }
